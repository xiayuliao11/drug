...
<!-- 引入kindeditor css -->
<link rel="styleSheet" href="../js/kindeditor-4.1.10/themes/default"/>
2.html
    <textarea id="content" ></textarea>
	<textarea id="hidmiaoshu" name="miaoshu" style="display:none;"></textarea>
3.ajax
$("#hidmiaoshu").html(editor.html())
4.引入kindeditor
var editor = null;
